...
echo "$($PSQL "SELECT SUM(opponent_goals)+SUM(winner_goals) FROM games AS total_goals")"
...
echo "$($PSQL "SELECT AVG(winner_goals+opponent_goals) FROM games AS average_goals")"
